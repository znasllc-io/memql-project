...
// product this file is GENERATED by the carrier's `make sdk-gen` (from core DSL
// + the product DSL) and re-exported by @__PRODUCT_ORG__/__PRODUCT__-sdk. This
// starter ships a hand-seeded subset so the shell builds standalone; run
// `make sdk-gen` in the sibling carrier to regenerate the full authoritative set
// and then import these from the SDK instead.
//
