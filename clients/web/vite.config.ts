...
// proxied to the bff front door (MEMQL_HTTP_URL, default
// https://bff.__DOMAIN__) so the browser talks same-origin; in the built image
// the ingress does the routing.
